...
import com.onepiece.reviewservice.filter.HeaderAuthenticationFilter;
...
public class SecurityConfig {
    ...
    private static  final String BASE_SERVICE_PATH= "/api/v1/review-service";
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(List.of("http://localhost:3000", "http://localhost:5173", "http://localhost:8089"));
        configuration.setAllowedMethods(List.of("GET", "POST", "PUT", "DELETE", "OPTIONS"));
        configuration.setAllowedHeaders(List.of("application", "Authorization", "Content-Type", "X-Requested-With", "Accept", "Origin", "*"));
