                      ...
                      <div className="w-40 flex flex-col justify-between text-center">
                        ...
                        <div className="flex flex-col gap-3 w-full">
                              {/* {auction.status === 'Scheduled' ? (
                                <>
                                  <button className="text-black text-xs font-semibold py-3 px-2 rounded-lg transition-colors" style={{ backgroundColor: '#312c26ff' }}>
                                    Start Now
                                  </button>
                                  <button className="border text-xs font-semibold py-3 px-2 rounded-lg transition-colors text-white border-white">
                                    Edit
                                  </button>
                                </>
                              ) : (
