...
import mercedesImg from '../../assets/Data/1961_MercedesBenz_220_SE_Coupe/MERCEDESBENZCoupe-W111-112--2238_5.jpg';
import ferrariImg from '../../assets/Data/1969_Dino_246_GT/FERRARI-Dino-246-GT-1072_14.jpeg';
import porscheImg from '../../assets/Data/PORSCHE_911_Carrera_S_992_2019Present/PORSCHE-911-Carrera-S-6550_5.jpg';
        ...
        <div className="relative z-10">
          ...
          <div>
            ...
            <div className="flex items-center">
              ...
              <span className={`text-sm ml-2 ${bgColor === 'bg-white' ? 'text-gray-500' : 'text-gray-200'}`}>
                Since last month
              </span> */}
            </div>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8 flex flex-col">
          {/* <div className="flex flex-col md:flex-row md:items-start md:justify-between mb-8">
            <div>
              <h1 className="text-4xl font-bold" style={{color: '#FED6AA'}}>Admin Dashboard</h1>
            </div>
          </div> */}
